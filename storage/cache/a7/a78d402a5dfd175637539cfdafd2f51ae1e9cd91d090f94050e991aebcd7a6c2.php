...
class __TwigTemplate_cdab7bccad28c86ce51af4f50b6a130c52667986a334659062115482b8915340 extends Twig_Template
{
...
\tconsole.log(\$this.find('.panel-container > .col-sm-2').length);
\tif(layoutNumber <= \$this.find('.panel-container > .col-sm-2').length)
\t\$this.find('.panel-container').append('<div class=\"col-sm-12\"><button class=\"btn btn-default refine-loadmore\" type=\"button\" ><i class=\"fa fa-plus-square-o\" aria-hidden=\"true\"></i> More Layout</button></li>');
...
\t\t\t\$('.refine-loadmore').html('<i class=\"fa fa-plus-square-o\" aria-hidden=\"true\"></i> More Layout');
...
\t\t\t});
\t\t\t\$(this).addClass('open');
\t\t\t\$('.refine-loadmore').html('<i class=\"fa fa-minus-square-o\" aria-hidden=\"true\"></i> Less Layout');
\t\t}
\t});
}
\t\t
...
";
    ...
    {
        return array (  488 => 324,  347 => 186,  322 => 164,  311 => 155,  296 => 144,  291 => 142,  284 => 138,  216 => 72,  201 => 71,  197 => 69,  195 => 68,  192 => 67,  189 => 66,  187 => 65,  168 => 64,  162 => 61,  149 => 53,  143 => 49,  137 => 47,  131 => 45,  129 => 44,  116 => 38,  104 => 36,  101 => 35,  99 => 34,  93 => 33,  88 => 31,  80 => 30,  74 => 28,  72 => 27,  66 => 26,  56 => 18,  49 => 15,  45 => 14,  41 => 12,  33 => 9,  31 => 8,  19 => 1,);
    }
}
/* {{ header }} {{ column_left }} */
/* */
